    ...
    return (
        <div className="relative w-full h-screen mx-auto">
            <div className="overflow-hidden rounded-lg shadow-lg">
                <div className="flex w-screen sm:max-sm:max-h-full transition-transform duration-500 ease-in-out transform translate-x-full"
                    ...
                    {slides.map((slide, index) => (
                        <div key={index} className="w-full flex-shrink-0 ">
                            <img
                                src={slide}
                                alt={`Slide ${index + 1}`}
                                style={{maxWidth:"100%",height:"350px",width:"100%",objectPosition:"center 30%"}}
